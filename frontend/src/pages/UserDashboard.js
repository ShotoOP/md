...
function UserDashboard() {
  ...
  //     const response = await axios.get('https://md-url.onrender.com/api/plan-configurations', {
  ...
  useEffect(() => {
    ...
    const checkSession = async () => {
      try {
        ...
        await api.post("https://md-url.onrender.com/firebase-auth", {
          uid: user.id,
          email: user.email,
  ...
  const handleTicketSubmit = async (e) => {
    ...
    try {
      await api.post(
        "https://md-url.onrender.com/api/user/support-tickets",
        newTicket,
        {
          withCredentials: true,
        }
  ...
  const handleDownloadInvoice = async (invoiceId) => {
    try {
      const response = await api.get(
        `https://md-url.onrender.com/api/user/invoices/${invoiceId}/download`,
        {
          withCredentials: true,
          responseType: "blob",
        }
  ...
  useEffect(() => {
    const checkPlanExpiry = async () => {
      try {
        const response = await axios.get('https://md-url.onrender.com/api/user/check-plan-expiry', {
          withCredentials: true
        });
  ...
  const fetchPlanExpiryStatus = async () => {
    try {
      const response = await axios.get('https://md-url.onrender.com/api/plans/expiry-status', {
        withCredentials: true
      });
      ...
      {upgradedPlans.length > 0 ? (
        <div className="table-responsive">
          <table className="table table-dark table-striped">
            <thead>
              <tr>
                <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Old Plan</th>
                <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Old Price</th>
                <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>New Plan</th>
                <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>New Price</th>
                <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Upgrade Date</th>
              </tr>
            </thead>
            <tbody>
        ...
        <p className="text-white">No upgraded plans found.</p>
      )}
    </div>
  );
  ...
  const handleUpgradeClick = async (currentPlan) => {
    try {
      ...
      const response = await axios.get(
        `https://md-url.onrender.com/api/plan-configurations?type=${currentPlan.plan_type}`,
        {
          headers: {
            Authorization: `Bearer ${user.token}`
          }
  ...
  return (
    <div className="UserDashboard bg-dark">
      <Header />
      <div className="container-fluid mt-5 pt-4 bg-dark">
        ...
        <div className="row">
            ...
            <div className="position-sticky pt-3">
              ...
              <ul className="nav flex-column">
                <li className="nav-item">
                  <button
                    className={`nav-link btn shadow-none ${activeTab === "overview" ? "text-warning" : "text-white"
                      }`}
                ...
                <li className="nav-item">
                  <button
                    className={`nav-link btn shadow-none ${activeTab === "Plans"
                        ? "text-warning"
                        : "text-white"
                      }`}
                ...
                <li className="nav-item">
                  <button
                    className={`nav-link btn shadow-none ${activeTab === "billing" ? "text-warning" : "text-white"
                      }`}
                ...
                <li className="nav-item">
                  <button
                    className={`nav-link btn shadow-none ${activeTab === "referrals" ? "text-warning" : "text-white"
                      }`}
                ...
                <li className="nav-item">
                  <button
                    className={`nav-link btn shadow-none ${activeTab === "support" ? "text-warning" : "text-white"
                      }`}
          ...
          >
            ...
            {activeTab === "overview" && (
              <div>
                <div className="bg-dark text-white border-warning mb-4">
                  ...
                  <div className="card-body">
                    ...
                    <p className="text-white mb-0 small">Minimum withdrawal: ₹1</p>
                  </div>
                </div>
                  ...
                  <div className="col-md-6 mb-4">
                    ...
                    <div className="table-responsive">
                      <table className="table table-dark table-hover">
                        <thead>
                          <tr>
                            <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Date</th>
                            <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Amount</th>
                            <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Status</th>
                          </tr>
                        </thead>
                        <tbody>
                          {invoices.slice(0, 3).map((invoice) => (
                            <tr key={invoice.id}>
                              ...
                              <td>
                                <span
                                  className={`badge bg-${invoice.status === "paid"
                                      ? "success"
                                      : "warning"
                                    }`}
                                >
                    ...
                    <div className="table-responsive">
                      <table className="table table-dark table-hover">
                        <thead>
                          <tr>
                            <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Date</th>
                            <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Subject</th>
                            <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Amount</th>
                          </tr>
                        </thead>
                        <tbody>
                          {supportTickets.slice(0, 3).map((ticket) => (
                            <tr key={ticket.id}>
                              ...
                              <td>
                                <span
                                  className={`badge bg-${ticket.status === "open"
                                      ? "warning"
            ...
            <div className="row mt-4 mb-4">
              <div className="col-12">
                <div className="bg-dark text-white border-warning">
                  <div className="header bg-warning text-dark">
                    <h5 className="mb-2 p-2">Investment Wallet</h5>
                  </div>
                  <br />
                  <div className="card-body">
                    <div className="row">
                      <div className="col-md-4 mb-3">
                        <div className="card bg-dark border-warning h-100">
                          <div className="card-body text-center">
                            ...
                            <p className="text-white mt-2 mb-0">Invested Amount</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-4 mb-3">
                        <div className="card bg-dark border-warning h-100">
                          <div className="card-body text-center">
                            <h6 className="text-white mb-3">Referral Earnings</h6>
                            <h4 className="text-warning mb-0">
                              ${referralEarnings.toFixed(2)}
                            </h4>
                            <p className="text-white mt-2 mb-0">Earned from referrals</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-4 mb-3">
                        <div className="card bg-dark border-warning h-100">
                          <div className="card-body text-center">
                            <h6 className="text-white mb-3">Daily Addition</h6>
                            <h4 className="text-warning mb-0">
                              +${calculateDailyAddition(userPlans).toFixed(2)}
                            </h4>
                            <p className="text-white mt-2 mb-0">Added to your balance daily</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-4 mb-3">
                        <div className="card bg-dark border-warning h-100">
                          <div className="card-body text-center">
                            <h6 className="text-white mb-3">Final Balance</h6>
                            <h4 className="text-warning mb-0">
              ...
              <div>
                ...
                {userPlans.length > 0 ? (
                  ...
                  <div className="text-center p-5">
                    ...
                    <p className="text-white">You don't have any active investment plans.</p>
                    <button
                ...
                <div className="mt-5">
                  <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-warning">
                    <h1 className="h2 text-warning">Upgrade Plan History</h1>
                  </div>
                  {userPlans.some(plan => plan.is_upgraded) ? (
                    ...
                    <p className="text-white">No upgrade history found.</p>
                  )}
                </div>
              </div>
            )}
            ...
            {activeTab === "referrals" && (
              <div>
                ...
                <div className="row">
                  <div className="col-md-6 mb-4">
                    <div className="bg-dark border-warning">
                      <div className="card-header bg-warning text-dark">
                        <h5 className="mb-2 p-2">Your Referral Link</h5>
                      </div>
                      <div className="card-body">
                    ...
                    <div className="bg-dark border-warning mt-4">
                      <div className="header p-2 mb-2 bg-warning text-dark">
                  ...
                  <div className="col-md-6 mb-4">
                    <div className="bg-dark border-warning h-100">
                      <div className="card-header bg-warning text-dark">
                        <h5 className="mb-2 p-2">Referral History</h5>
                      </div>
                      <div className="card-body">
                        {referralHistory.length > 0 ? (
                          <div className="table-responsive">
                            <table className="table table-dark table-hover">
                              <thead>
                                <tr>
                                  <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Date</th>
                                  <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>User</th>
                                  <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Plan</th>
                                  <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Earnings</th>
                                </tr>
                              </thead>
                              <tbody>
                          ...
                          <div className="text-center p-5">
                            ...
                            <h4 className="text-white">No Referrals Yet</h4>
                            <p className="text-white">
                ...
                {invoices.length > 0 ? (
                  <div className="table-responsive">
                    <table className="table table-dark table-hover">
                      <thead>
                        <tr>
                          <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Invoice #</th>
                          <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Date</th>
                          <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Plan</th>
                          <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Amount</th>
                          <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Status</th>
                          <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Actions</th>
                        </tr>
                      </thead>
                      <tbody>
                  ...
                  <div className="modal-content bg-dark text-white border-warning">
                    ...
                    <div className="modal-body">
                      <form onSubmit={handleWithdrawSubmit}>
                        <div className="mb-3">
                          <label className="form-label text-white">Available Balance</label>
                          <input
                            type="text"
                            className="form-control bg-dark text-white border-warning"
                        ...
                        <div className="mb-3">
                          <label className="form-label text-white">Withdrawal Amount</label>
                          <input
                            type="number"
                            className="form-control bg-dark text-white border-warning"
                        ...
                        <div className="mb-3">
                          <label className="form-label text-white">Remarks (Optional)</label>
                          <textarea
                            className="form-control bg-dark text-white border-warning"
                  ...
                  <table className="table table-dark table-hover">
                    <thead>
                      <tr>
                        <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Date</th>
                        <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Amount</th>
                        <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Bank Details</th>
                        <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Status</th>
                        <th style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Remarks</th>
                      </tr>
                    </thead>
                    <tbody>
